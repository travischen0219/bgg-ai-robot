    ...
    for event in events:
        ...
        if response == False:
            ...
            try:
                ...
                line_bot_api.push_message(event.reply_token, ImageSendMessage(original_content_url="https://www.facebook.com/travis.ming.xin", preview_image_url=image_url))
                line_bot_api.push_message(event.reply_token, TextSendMessage(text="雖然不知道你在說甚麼，但還是給你看看我的帥臉"))
